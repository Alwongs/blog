...
const todoList = document.querySelector('.product-list');
if (todoList) {
    todoList.addEventListener('click', function(e) {
        let modals = document.querySelectorAll('.product-list-item__modal');
...
document.addEventListener('click', (e) => {
    let modal = document.querySelector('.product-list-item__modal:not(.hidden)')
